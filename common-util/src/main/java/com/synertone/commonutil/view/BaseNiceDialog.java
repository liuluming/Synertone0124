...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = (int) (ScreenUtil.getWidth(getActivity()) - 2 * ScreenUtil.dip2px(getActivity(), margin));
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = ScreenUtil.dip2px(getActivity(), width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = ScreenUtil.dip2px(getActivity(), height);
            }
