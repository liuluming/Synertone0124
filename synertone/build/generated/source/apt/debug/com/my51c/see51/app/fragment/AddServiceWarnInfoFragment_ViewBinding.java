...
public class AddServiceWarnInfoFragment_ViewBinding implements Unbinder {
  private AddServiceWarnInfoFragment target;

  @UiThread
  public AddServiceWarnInfoFragment_ViewBinding(AddServiceWarnInfoFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AddServiceWarnInfoFragment target = this.target;
