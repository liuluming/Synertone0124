...
public class SmartGatewayWarnInfoFragment_ViewBinding implements Unbinder {
  private SmartGatewayWarnInfoFragment target;

  @UiThread
  public SmartGatewayWarnInfoFragment_ViewBinding(SmartGatewayWarnInfoFragment target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SmartGatewayWarnInfoFragment target = this.target;
