...
public class RemoteDeviceActivity_ViewBinding implements Unbinder {
  private RemoteDeviceActivity target;

  @UiThread
  public RemoteDeviceActivity_ViewBinding(RemoteDeviceActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public RemoteDeviceActivity_ViewBinding(RemoteDeviceActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RemoteDeviceActivity target = this.target;
